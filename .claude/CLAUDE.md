...
- **Creating tasks**: Run `./tasks/new.sh "slug" "Title"` to create a file with the next available number. Never pick a number manually. Always invoke the script directly (`./tasks/new.sh`) — do not prefix with `bash`.
